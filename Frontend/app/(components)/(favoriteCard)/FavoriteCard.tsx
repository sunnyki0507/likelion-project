...
import { saveFavoriteRestaurant } from "./SaveFavorite"
import { deleteFavoriteRestaurant } from "./SaveFavorite"
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden h-full flex flex-col">
      ...
      <div className="relative h-48 w-full">
        <Image
          ...
          priority
        />
        <button onClick={toggleFavorite} className="absolute top-3 right-3 p-2 bg-white rounded-full shadow-md">
          {isFavorite ? (
