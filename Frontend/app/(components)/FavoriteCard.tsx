...
//           {/* Likes Counter */}
//           <div className="inline-flex items-center gap-2 border border-gray-200 rounded-full px-4 py-1.5 w-fit mb-4">
//             <HeartIcon className="w-4 h-4 text-red-500" />
//             <span className="text-sm font-medium">{restaurant.likes || 500}</span>
//           </div>
...
//           <button className="mt-6 px-6 py-3 bg-black text-white rounded-full hover:bg-gray-800 w-fit">
//             View More...
//           </button>
//         </div>
